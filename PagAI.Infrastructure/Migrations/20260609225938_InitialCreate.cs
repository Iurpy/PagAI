        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoCalculoJuros = table.Column<int>(type: "integer", nullable: false),
                    TipoCobrancaJuros = table.Column<int>(type: "integer", nullable: false),
                    TipoCobrancaAtraso = table.Column<int>(type: "integer", nullable: false),
                    ValorJuros = table.Column<decimal>(type: "numeric", nullable: false),
                    ValorAtraso = table.Column<decimal>(type: "numeric", nullable: false),
                    IgnorarSabados = table.Column<bool>(type: "boolean", nullable: false),
                    IgnorarDomingos = table.Column<bool>(type: "boolean", nullable: false),
                    IgnorarFeriados = table.Column<bool>(type: "boolean", nullable: false),
                    Observacao = table.Column<string>(type: "text", nullable: true),
                    Ativo = table.Column<bool>(type: "boolean", nullable: false),
                    DataCadastro = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
